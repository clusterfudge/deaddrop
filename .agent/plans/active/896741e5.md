...
**Updated:** 2026-01-24 07:47:30 UTC
**Status:** in-progress
...
###  Backend Implementations (0✓/3)
_Local, Remote, and InMemory backend classes_

- ⬜ **Create Backend abstract base class and LocalBackend** (id: e04868b7) [READY]
...
- ⬜ **Create RemoteBackend implementation** (id: 74d986d9) [BLOCKED by e04868b7]
...
- ⬜ **Create InMemoryBackend for testing** (id: 1f932cf7) [BLOCKED by e04868b7]
...
- ⬜ **Create unified Deaddrop client class** (id: d2be1d1a) [BLOCKED by e04868b7, 74d986d9, 1f932cf7]
...
- ⬜ **Update package exports and __init__.py** (id: 78b62607) [BLOCKED by d2be1d1a]
...
###  CLI & Testing Integration (0✓/2)
_CLI refactor and pytest fixtures_

- ⬜ **Refactor CLI to use Deaddrop client** (id: 846ab08e) [BLOCKED by d2be1d1a]
...
- ⬜ **Add pytest fixtures in deadrop.testing module** (id: 04c3eb28) [BLOCKED by d2be1d1a]
...
- ⬜ **Add documentation for unified client and local namespaces** (id: 561976db) [BLOCKED by 846ab08e, 04c3eb28]
...
<!-- plan-data
{
  ...
  "updated_at": "2026-01-24T07:47:30.526919+00:00",
  "root_dirs": [
