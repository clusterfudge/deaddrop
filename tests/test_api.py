...
class TestLongPolling:
    ...
    See test_subscribe_api.py and test_subscribe_client.py for real-time
    update testing via the subscription/SSE system.
    """
...
class TestConcurrency:
    ...
    The old long-poll concurrency test was removed since long-polling has been
    replaced by the subscription system. The run_in_executor approach used by
    async handlers ensures db calls don't block the event loop.
    """
