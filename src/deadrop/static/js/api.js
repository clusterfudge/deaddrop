...
const DeadropAPI = {
     ...
     */
    async getRoomMessages(credentials, roomId, { afterMid = null, beforeMid = null, limit = null, excludeReactions = false } = {}) {
        ...
        if (excludeReactions) params.set('exclude_reactions', 'true');
        if (params.toString()) path += '?' + params.toString();
